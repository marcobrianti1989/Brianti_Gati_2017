function [data, var_names] = read_data3(filename, sheet, range, base_path)
% This file is a copy of read_data2.m. The only difference is how it treats
% the base_path. Below is the description of read_data2.
% A completely general function for reading in data. The only
