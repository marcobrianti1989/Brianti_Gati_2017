...
%  I OBTAIN THE SAME P AND THE SAME SS SOLUTION AS WHEN I SET P AS ABOVE.
...
eq1  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) yc - biggamc * ki^gam * h1^(1-a-b) * kc1^a * ki1^b;
eq2  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) yi - biggami * ki^gam * h2^(1-a-b) * kc2^a * ki2^b;
eq3  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) kc -kc1 -kc2;
eq4  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ki -ki1 -ki2;
eq5  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) h -h1 -h2;
eq6  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) kc * gc - ic;
eq7  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ki * gi - it;
eq8  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) yc - c -ic;
eq9  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) yi -it;
eq10 = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) w/c -chi;
eq13  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ...
    w -(1-a-b)*biggamc * ki^gam * h1^(-a-b) * kc1^(a) * ki1^(b);
eq14  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ...
    rc -(a)*biggamc * ki^gam * h1^(1-a-b) * kc1^(a-1) * ki1^(b);
eq15  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ...
    ri -(b)*biggamc * ki^gam * h1^(1-a-b) * kc1^(a) * ki1^(b-1);
eq16  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ...
    w/p -(1-a-b)*biggami * ki^gam * h2^(-a-b) * kc2^(a) * ki2^(b);
eq17  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ...
    rc/p -(a)*biggami * ki^gam * h2^(1-a-b) * kc2^(a-1) * ki2^(b);
eq18  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p) ...
...
%      yc   yi   h1   h2   h    kc1  kc2  kc    ki1  ki2   ki   ic    it   c    w   p
x0 = [0.69, 0.1, 0.8, 0.1, 0.9, 0.7, 0.1, 0.79, 0.5, 0.1, 0.6, 0.06, 0.1, 0.6, 0.6, 0.9];
% lb = [0,0,0,0,0.00001];
% ub = [1,1,1,1,1000000];
% x0 = 1*ones(1,16);
lb = zeros(1,16);
...
out(1,1)     = eq1(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq2(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq3(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq4(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq5(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq6(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq7(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq8(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq9(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq10(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq13(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq14(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq15(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq16(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq17(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
out(end+1,1) = eq18(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w, p);
