...
Using a similar notation in Section \ref{section:empiricalstrategy_simple}, assume for simplicity  that $B(L)$ allows only of one lag.

\

\textbf{Step 1 - Identification of $\gamma_{news}$}
$$
\max_{\gamma_{news}} \frac{\sum_{\tau = 0}^H B_{}}{}
$$
