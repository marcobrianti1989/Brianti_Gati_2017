...
% MIRRORS MODEL_SPILLOVER_SS_NEWS.M, ONLY BIGGAMC AND BIGGAMI ARE
% REOPTIMIZED GIVEN THE VALUE OF GAMMA.

function [ss,param] = model_spillover_ss_news_reoptBiggammas(param)
...
% biggami  = param.biggami; % growth rate of equipment productivity HERE
% THESE GUYS ARE NO LONGER PARAMETERS
...
%%% NEW IN THIS CODE: Biggamc and Biggami solve the following system:
gc_mean = 0.002942; % growth rate averages from data, taken from evaluate_gamC_gamI.m
gp_mean = - 0.0126;
...
biggamc = 1+gamC;
biggami = 1+gamI;
param.biggamc = biggamc;
param.biggami = biggami;
%%%
