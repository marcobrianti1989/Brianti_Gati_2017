...
eq1  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) yc - biggamc * h1^(1-a-b) * kc1^a * ki1^b;
eq2  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) yi - biggami * h2^(1-a-b) * kc2^a * ki2^b;
...
eq13  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) ...
    w -(1-a-b)*biggamc * h1^(-a-b) * kc1^(a) * ki1^(b);
eq14  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) ...
    rc -(a)*biggamc * h1^(1-a-b) * kc1^(a-1) * ki1^(b);
eq15  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) ...
    ri -(b)*biggamc * h1^(1-a-b) * kc1^(a) * ki1^(b-1);
eq16  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) ...
    w -(1-a-b)*biggami * h2^(-a-b) * kc2^(a) * ki2^(b);
eq17  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) ...
    rc -(a)*biggami * h2^(1-a-b) * kc2^(a-1) * ki2^(b);
eq18  = @(yc, yi, h1, h2, h, kc1, kc2, kc, ki1, ki2, ki, ic, it, c, w) ...
    ri -(b)*biggami * h2^(1-a-b) * kc2^(a) * ki2^(b-1);
% 16 eqs

% Let's try something similar for the Tzuo system.
