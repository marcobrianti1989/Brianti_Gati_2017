...
\veryHuge \color{NavyBlue} \textbf{ICT-Specific Investment Shocks and Economic  \\ Fluctuations} \color{Black}\\ % Title
\Huge\textit{Evidence and Theory of a General-Purpose Technology}\\[1cm] % Subtitle
\huge \textbf{Marco Brianti \& Laura G\'ati}\\ % Author(s)
