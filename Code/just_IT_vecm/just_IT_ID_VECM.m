function [impact, impact_IT_opt, gam_opt] = ...
      just_IT_ID_VECM(which_variable,which_shock,A,Xi,r)
...
Aeq(1,nvar) = 1; %zero-impact restrictions of IT on TFP

gam_opt = fmincon(obj, gam_zero,[],[],Aeq,Beq,[],[],@(gam) ...
      constraint_long_gamma(A,Xi,gam,r,nvar));
%fmincon(FUN,X0,A,B,Aeq,Beq,LB,UB,NONLCON,OPTIONS)
impact_IT_opt = objective_just_IT(which_variable,A,gam_opt);
impact_IT_opt     = - impact_IT_opt;

if (gam_opt'*gam_opt - 1)^2 > 10^(-8) || gam_opt(nvar)^2 > 10^(-12)
