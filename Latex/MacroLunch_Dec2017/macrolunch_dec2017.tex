...
\item One strand of literature: Exogenous TFP and news shocks
	...
	\end{itemize}
\item [] \textbf{Our contribution: allow in this setting for the existence of an endogenous mechanism that affects future TFP}	
...
\begin{figure}
	\centering
	\includegraphics[scale=0.15]{\ourFigPath Figures/fig_News_Shock_on_TFP_Ryan_two_stepsID_06-Dec-2017_14_00_39}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.15]{\ourFigPath Figures/fig_IT_Shock_on_TFP_Ryan_two_stepsID_06-Dec-2017_14_00_47}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
	\centering
	\includegraphics[scale=0.15]{\ourFigPath Figures/fig_News_Shock_on_Real_SP_Ryan_two_stepsID_06-Dec-2017_14_00_40}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.15]{\ourFigPath Figures/fig_IT_Shock_on_Real_SP_Ryan_two_stepsID_06-Dec-2017_14_00_48}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{multicols}{2}
\centering
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_News_Shock_on_Real_IT_Investment_Ryan_two_stepsID_06-Dec-2017_14_00_41}\\  
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_News_Shock_on_Real_GDP_Ryan_two_stepsID_06-Dec-2017_14_00_43}\\ 
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_News_Shock_on_Real_Consumption_Ryan_two_stepsID_06-Dec-2017_14_00_44}\\ 
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_News_Shock_on_Relative_Price_Ryan_two_stepsID_06-Dec-2017_14_00_45}\\ 


\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_IT_Shock_on_Real_IT_Investment_Ryan_two_stepsID_06-Dec-2017_14_00_49}\\
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_IT_Shock_on_Real_GDP_Ryan_two_stepsID_06-Dec-2017_14_00_51}\\
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_IT_Shock_on_Real_Consumption_Ryan_two_stepsID_06-Dec-2017_14_00_52}\\ 
\includegraphics[scale = 0.08]{\ourFigPath Figures/fig_IT_Shock_on_Relative_Price_Ryan_two_stepsID_06-Dec-2017_14_00_53}\\ 
...
\begin{enumerate}
 ...
 %\ 
	...
	\item ... as well as the conjecture that the IT shock looks similar to news along certain dimensions, 
...
\item Shares of FEV of TFP explained ...
	\begin{itemize}
	\item ... also reflect the Barsky \& Sims result in that the contribution of the news shock is still significant...
	
	\item [] (For BS, news explains around 45\%, compared to 25\% here)
	
	\
	
	\item ... yet suggest that the IT shock plays a very important role as well (50\%)
	
	\
	
	\item ... and was previously - as anticipated by BS - partly counfounded with news!
	\end{itemize}
...
\begin{itemize}
\item We provided what we think (and we hope you do too) a careful and more general test for the endogenous mechanism in TFP.
\begin{itemize}
