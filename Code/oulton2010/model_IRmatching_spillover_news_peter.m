...
function [mod] = model_IRmatching_spillover_news_peter(param,set)

%Steady State Function Call
mod.ss_call = 'model_ss_IRmatching_spillover_news_peter.m'; %%%%%%%%%%%%% DEFAULT
% mod.ss_call = 'model_ss_IRmatching_spillover_news2.m'; %%%%%%%%%%%%% L added _IRmatching_spillover_news (use no. 2)  
% mod.ss_call = 'model_ss_IRmatching_spillover_news_other_ki.m'; %%%%%%%%%%%%% L: alternative to try to get gam = 0 to work too %%% mod.ss_call = 'model_ss_IRmatching_spillover_news_reopt.m'; %%%%%%%%%%%%% L: alternative to reoptimize for Biggammas
...
% First resolve steady-state so you get the new st.st.-shares...
 [Xss,Yss] = model_ss_IRmatching_spillover_news_aux(param,set); %%%%%%%%%%%%%%% DEFAULT (should be fine for Peter since shares shouldn't be affected by scaling)
