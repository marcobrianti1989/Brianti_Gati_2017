% PARAMETERS_OPT - Just to input the optimal parameters from IR-matching
%
% usage
%
% param = parameters
...
function param = parameters_opt() %GHK params if not stated, else IR-matched optimal params
...
param.gam      = 0.5873; %0.2 spillover elasticity (only used in model_spillover.m and model_spillover_ss.m) 0.5873 is the optimal value from IR-matching
