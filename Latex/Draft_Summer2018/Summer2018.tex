...
As a last step, we use both our empirical and theoretical results to estimate the key parameters of the model via impulse-response function matching to an ICT technology shock. The key parameters within this set are (i) the effectiveness of the spillover effect on the production functions, and (ii) the standard deviation and (iii) persistence of ICT technology shocks.
