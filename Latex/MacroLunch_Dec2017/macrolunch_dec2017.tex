...
%%%%%%% Slide %%%%%%
\begin{frame}
	\frametitle{Results - Impulse responses to a news shock}
...
%%%%%%% Slide %%%%%%
\begin{frame}
	\frametitle{Results - Impulse responses to an IT shock}
...
%%%%%%% Slide %%%%%%
\begin{frame}
	\frametitle{Results - FEV of TFP explained by the two shocks}
