...
Secondly, a long line of literature going back to the early 1990s postulates that ICT may be a general-purpose technology.\footnote{\cite{basu2003case}, \cite{basu2007information}, \cite{fernald2017disappointing} and \cite{oliner2000resurgence} and are some examples.} Following the classical definition of \cite{bresnahan1992general}, GPTs are technologies that alter the process of economy-wide production, and thus affect the productivity of the entire economy.

The general-purpose nature of ICT capital works through its own diffusion because information sharing improves only when new communication technologies are widely spread over the population.
