...
set.a        = 0.13;  %0.13 share of standard capital (should be param eventually)
set.b        = 0.17; %0.17 share of IT capital (should be param eventually)
...
param.sige     = 1; %2 variance of signal on BIGGAMI
