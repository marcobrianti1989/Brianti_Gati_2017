...
ri = (1/bet* (biggamc)^((1-b)/(1-a-b)) *(biggami)^((b)/(1-a-b)) -(1-di))*p; 
...
h1     = w/(chi*(biggamc)*kc1_h1^a*ki1_h1^b - chi*2*kc1_h1*( ...
    ((biggamc)^((1-b)/(1-a-b)) *(biggami)^((b)/(1-a-b))) - (1-dc))); %eq.4 and p. 293 comment
