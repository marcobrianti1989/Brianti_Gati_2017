...
param.gami     = 1.032; % growth rate of IT productivity
param.gamc     = 1.00328;    % growth rate of cons. productivity
param.di       = 0.124; %0.124; % depreciation rate of IT capital (Some work suggests 0.1830)
param.dc       = 0.056; % depreciation rate of standard capital
param.chi      = 1; % preference parameter in labor disutility.
