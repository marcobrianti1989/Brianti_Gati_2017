...
Using the same notation in Section \ref{section:empiricalstrategy_simple}, our identification strategy can be presented as follows,\footnote{Also in this case we keep following the same notation of \cite{barsky2011news}.}

\

\textbf{Step 1 - Identification of $\gamma_{news}$}
$$
\max_{\gamma_{news}} \sum_{h = 0}^{H} \Sigma
$$
