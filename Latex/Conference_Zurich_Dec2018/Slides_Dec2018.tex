...
\hyperlink{wrong_timing}{\beamerbutton{Argument}}	
...
\begin{frame}
	...
	\item ICT and productivity 
		\begin{itemize}
		\item Jorgenson \& Stiroh (1999), Oliner \& Sichel (2000),  Brynjolffson \& Lorin (2000), Stiroh (2002) %Brynjolffson \& Yang (1999) %use stock market valuations of firms to identify the value of IT assets
		\end{itemize}
...
\hyperlink{tfp_in_model}{\beamerbutton{TFP in the model}}	
...
and calibrate the rest.  \hyperlink{calibration}{\beamerbutton{Calibration}}	
...
\hyperlink{uses}{\beamerreturnbutton{Return}}	
...
\footnotesize
	\begin{center}
		\begin{tabular}{clcl}
			...
			\hline
		\end{tabular}
		%\caption{$\beta$: Match average yield of 3month T-bill 1989:Q1-2017:Q1. $delta^i: match the higher of two BEA annual depreciation items that both correspond to ICT }
		\label{table:estimated_parameters}
	\end{center}
\end{table}	
...
\hyperlink{IRmatching}{\beamerreturnbutton{Return}}	
