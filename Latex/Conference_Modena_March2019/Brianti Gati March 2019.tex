...
\bigskip
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item A contemporaneous increase in ICT investment leads to delayed, persistent, and large rise in productivity
             \item Historical decomposition confirms that the doc-com crash explains most of the slowdown in TFP since 2006 
		\end{itemize}
	...
	\
		...
		\item Our identified shocks can be interpreted as supply shocks specific to the ICT sector
         \item ICT capital goods boosts productivity of ICT users thorugh a positive externality
\begin{itemize}
...
We extend and analyze a 2-sector GE model in the spirit of Greenwood et al. (2007). Two main assumptions are in place,
\begin{itemize}
\item[1.] Second sector specifically produce ICT durable goods to be used as inputs in both sectors' production function
...
\item The fall in ICT investment during the doc-com crash has the right timing to rationalize the structural break in TFP
\end{itemize}
